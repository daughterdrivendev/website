...
There’s something special about people like us who live in both worlds: one full of bugs, builds, and deadlines, and the other full of snacks, bedtime negotiations, and mysterious sticky substances. We don't talk about it enough, but parents in the industry carry a completely unique set of battle-hardened skills that make them exceptional at what they do.
...
Every day, every moment is just different and we've accepted it. We know how to wing it.
...
Creative panic is just part of being a parent. When the obvious solution doesn't work, you improvise. You invent. You turn a cardboard box into a spaceship and a problem into an opportunity. That same muscle shows up when you're architecting a solution nobody's thought of yet, or finding a workaround that saves the entire sprint.

Forgot about that costume for tomorrow and it's 9pm already? You wing it.

#### We manage time like it's critically endangered.
Nap windows. School runs. Sprint deadlines. Quarterly reviews. Parents optimise ruthlessly because every minute is accounted for. We don't waste meetings. We don't let tasks drift. Time is precious, and we've been trained by the most demanding product managers alive... our kids.

We simply do not have time browsing social media during working hours. We have this limited time window and we need to get sh*t done.
